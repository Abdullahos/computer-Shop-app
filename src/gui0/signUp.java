...
public class signUp extends store {
    ...
    private void initComponents() {
        ...
        jPanel7.setBackground(new java.awt.Color(33, 42, 50));
        ...
        UpUserName.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        UpUserName.setText("user name");
        UpUserName.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                UpUserNameMouseClicked(evt);
            }
        });
        ...
        upRePass.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                upRePassMouseClicked(evt);
            }
        });
        ...
        phoneNoTxtField.setText("11 numbers");
        ...
        goToLoginButton.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        goToCatalog.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        goToCatalog.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(UpUserName, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void signUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpButtonActionPerformed
        ...
        if(! isError ){
            ...
            {
                Customer customer = new Customer( userName, pass1, address, phoneNo);
                CustomerService customerService = new CustomerService(customer);
                int insertRes = customerService.addCustomer();
                ...
                if(insertRes == 1) JOptionPane.showMessageDialog(null,"account created :D");
                else JOptionPane.showMessageDialog(null,"error happend");
            }
        }
    ...
    private void UpUserNameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpUserNameMouseClicked
        UpUserName.setText("");
    }//GEN-LAST:event_UpUserNameMouseClicked
    ...
    private void upRePassMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_upRePassMouseClicked
        upRePass.setText("");
    }//GEN-LAST:event_upRePassMouseClicked
